...
class TestUrl extends TestCase {
	...
	public void testIsAPicture() {
		...
		u.setUrl("https://fr.wikipedia.org/wiki/Game_of_Thrones#/media/File:Correspondance_Chap%C3%AEtres_livres_-_S%C3%A9rie_Game_of_Thrones4.png");
		Assertions.assertTrue(u.isAPicture());
		...
		u.setUrl("https://fr.wikipedia.org/wiki/Coupe_du_monde_de_football#/media/File:Jogo_no_Est%C3%A1dio_do_Maracan%C3%A3,_antes_da_Copa_do_Mundo_de_1950.tif");
		Assertions.assertTrue(u.isAPicture());
